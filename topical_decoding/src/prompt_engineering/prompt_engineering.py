...
AutoTokenizer class. 
Results are stored in JSON files in the data/results_prompt_engineering folder.
"""
...
from config import DATASET_CONFIG, EXPERIMENT_CONFIG, GENERATION_CONFIG
...
def main():
    ...
    file_name = (
        f"{experiment_name}_{EXPERIMENT_CONFIG['model_alias']}_"
    ...
    results_dir = os.path.join(
        parent_dir, "data", "results_prompt_engineering", file_name
    )

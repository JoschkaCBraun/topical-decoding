...
from utils.newts_lda_utils import read_NEWTS_train, read_LDA, get_topic_words
    ...
    try:
        ...
        for i in range(min(N_ARTICLES, len(train))):
            ...
            for topic_id in [tid1, tid2]:
                ...
                doc_topic_dict = {"document": document, "topic_words": topic_words, "summary": summary1 if topic_id == tid1 else summary2}
